...
@Public
@Unstable
public abstract class FederationDeleteApplicationRequest {

  @Private
  @Unstable
  public static FederationDeleteApplicationRequest newInstance(
      ApplicationId applicationId) {
    FederationDeleteApplicationRequest deleteApplicationRequest =
        Records.newRecord(FederationDeleteApplicationRequest.class);
