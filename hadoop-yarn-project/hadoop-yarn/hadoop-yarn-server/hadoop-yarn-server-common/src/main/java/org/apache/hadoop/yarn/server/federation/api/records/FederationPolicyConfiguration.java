...
import org.apache.hadoop.yarn.server.federation.policies.FederationPolicy;
import org.apache.hadoop.yarn.server.federation.policies.FederationPolicyWriter;
 ...
 * configuration of a {@link FederationPolicy}. It contains a policy type (resolve to a class
 ...
 * the federation state store. The intended lifecycle is for this
 * {@link ByteBuffer} to be generated by serializing a
 * {@link FederationPolicyConfiguration} provided by a
 * {@link FederationPolicyWriter}. This ensure compatibility of reader/writer
 * and helps us make early consistency checks before the params are
 * serialized in the {@link FederationPolicyStore}.
 */
@Public
@Unstable
