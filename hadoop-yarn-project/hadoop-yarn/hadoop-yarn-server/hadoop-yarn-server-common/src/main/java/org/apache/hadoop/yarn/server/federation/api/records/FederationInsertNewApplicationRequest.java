...
@Public
@Unstable
public abstract class FederationInsertNewApplicationRequest {

  @Private
  @Unstable
  public static FederationInsertNewApplicationRequest newInstance(
      FederationApplicationInfo federationApplicationInfo) {
    FederationInsertNewApplicationRequest registerRequest =
        Records.newRecord(FederationInsertNewApplicationRequest.class);
    registerRequest.setApplicationInfo(federationApplicationInfo);
