...
public class RegistryOperationsStoreService extends CompositeService
  ...
  public RegistryOperationsStoreService() {
    super(RegistryOperationsStoreService.class.getName());
  }
